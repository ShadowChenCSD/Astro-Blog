...
export const ja: Translation = {
	...
	[Key.animeSubtitle]: "私のアニメ旅行記録して、採点はBangumi番組計画",
	...
	// 游戏页面
	[Key.gameTitle]: "ゲームコレクション",
	[Key.gameSubtitle]: "私のゲーム履歴記録して、採点はBangumi番組計画", 
	[Key.gameList]: "ゲームリスト",
	[Key.gameTotal]: "総数",
	[Key.gamePlaying]: "プレイ中",
	[Key.gameCompleted]: "クリア",
	[Key.gamePlanned]: "計画中",
	...
	[Key.gameYear]: "年",
	[Key.gameRating]: "評価",
	[Key.gameFilterAll]: "全て",

	// 短文页面
	[Key.diarySubtitle]: "生活をシェア",
